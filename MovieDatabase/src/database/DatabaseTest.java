...
/**
 * Demonstrates how to create a database, drop and insert tables, and access
...
public class DatabaseTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			validateTables(connection, statement);
